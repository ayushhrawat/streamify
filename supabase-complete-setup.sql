-- COMPLETE SUPABASE SETUP FOR STREAMIFY
...
-- Message deletions table (for delete for everyone feature)
...
CREATE POLICY "users_select_policy" ON users
    FOR SELECT USING (true); -- Allow reading all users for chat functionality
...
-- Enable realtime for tables (optional - can be disabled if causing issues)
